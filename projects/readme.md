...
Build your project in your external repo and (if required) deploy it.
In this roadmap repo, create projects/<project-key>/README.md using the template below.
Update the root index.html to link to your live URL (preferred) or pointer page.
Open the corresponding project issue on your board and:
